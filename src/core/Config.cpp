...
static const QHash<Config::ConfigKey, ConfigDirective> configStrings = {
    ...
    {Config::Security_ClearClipboardTimeout, {QS("Security/ClearClipboardTimeout"), Roaming, 5}},
    ...
    {Config::Security_HideNotes, {QS("Security/Security_HideNotes"), Roaming, true}},
    {Config::Security_LockDatabaseIdle, {QS("Security/LockDatabaseIdle"), Roaming, true}},
    {Config::Security_LockDatabaseIdleSeconds, {QS("Security/LockDatabaseIdleSeconds"), Roaming, 300}},
    {Config::Security_LockDatabaseMinimize, {QS("Security/LockDatabaseMinimize"), Roaming, true}},
